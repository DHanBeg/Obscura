// #30 web — marketplace HTTP client. Mobile'ın lib/marketplace-api.ts'iyle
// AYNI 12 endpoint, aynı şema — sadece transport (frontend/lib/api.ts'in
// apiFetch'i, localStorage token) mobile'dan farklı. Mock/placeholder data
// YOK, gerçek backend/internal/api/marketplace_handlers.go'ya bağlı.
