...
KNOWN_KEYS="NODE_INTERNAL_SECRET INTERNAL_SECRET JWT_SECRET OBSCURA_PHONE_PEPPER OBSCURA_MESSAGE_OWNER_PEPPER OBSCURA_LOG_REDACT_KEY MINIO_ACCESS_KEY MINIO_SECRET_KEY TURN_SHARED_SECRET POSTGRES_PASSWORD GF_SECURITY_ADMIN_PASSWORD"
